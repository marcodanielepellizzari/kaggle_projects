#loading script for file GlobalLandTemperaturesByMajorCity.csv
...
for line in f:
	...
	if totlines%lines_per_insert==0:
		try:
			cur.prepare("INSERT INTO TEMPERATURE.TEMP_MAJ_CITY(DATA,TEMPERATURE,ERROR,IDCITY) VALUES(:1,:2,:3,:4)")
